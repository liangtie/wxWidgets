...
{
    wxString *families = NEW_DEBUG wxString[6],
             *styles = NEW_DEBUG wxString[3],
             *weights = NEW_DEBUG wxString[3];
    families[0] =  _("Roman");
...
#if !USE_SPINCTRL_FOR_POINT_SIZE
    wxString *pointSizes = NEW_DEBUG wxString[40];
    int i;
    for ( i = 0; i < 40; i++)
    {
        wxChar buf[5];
    ...
    wxFlexGridSizer* itemGridSizer4 = NEW_DEBUG wxFlexGridSizer(noRows, noCols, 0, 0);
    ...
    wxStaticText* itemStaticText6 = NEW_DEBUG wxStaticText( this, wxID_STATIC, _("&Font family:"), wxDefaultPosition, wxDefaultSize, 0 );
    itemBoxSizer5->Add(itemStaticText6, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT|wxTOP, 5);

    m_familyChoice = NEW_DEBUG wxChoice( this, wxID_FONT_FAMILY, wxDefaultPosition, wxDefaultSize, 5, families, 0 );
    ...
    wxStaticText* itemStaticText9 = NEW_DEBUG wxStaticText( this, wxID_STATIC, _("&Style:"), wxDefaultPosition, wxDefaultSize, 0 );
    itemBoxSizer8->Add(itemStaticText9, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT|wxTOP, 5);

    m_styleChoice = NEW_DEBUG wxChoice( this, wxID_FONT_STYLE, wxDefaultPosition, wxDefaultSize, 3, styles, 0 );
    ...
    wxStaticText* itemStaticText12 = NEW_DEBUG wxStaticText( this, wxID_STATIC, _("&Weight:"), wxDefaultPosition, wxDefaultSize, 0 );
    itemBoxSizer11->Add(itemStaticText12, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT|wxTOP, 5);

    m_weightChoice = NEW_DEBUG wxChoice( this, wxID_FONT_WEIGHT, wxDefaultPosition, wxDefaultSize, 3, weights, 0 );
    ...
    wxBoxSizer* itemBoxSizer14 = NEW_DEBUG wxBoxSizer(wxVERTICAL);
    itemGridSizer4->Add(itemBoxSizer14, 0, wxALIGN_CENTER_HORIZONTAL|wxGROW, 5);
    m_colourChoice = NULL;
    if (m_fontData.GetEnableEffects())
    {
        wxStaticText* itemStaticText15 = NEW_DEBUG wxStaticText( this, wxID_STATIC, _("C&olour:"), wxDefaultPosition, wxDefaultSize, 0 );
        ...
        m_colourChoice = NEW_DEBUG wxChoice( this, wxID_FONT_COLOUR, wxDefaultPosition, colourSize, NUM_COLS, wxColourDialogNames, 0 );
    ...
    wxStaticText* itemStaticText18 = NEW_DEBUG wxStaticText( this, wxID_STATIC, _("&Point size:"), wxDefaultPosition, wxDefaultSize, 0 );
    itemBoxSizer17->Add(itemStaticText18, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT|wxTOP, 5);

#if USE_SPINCTRL_FOR_POINT_SIZE
    m_pointSizeSpin = NEW_DEBUG wxSpinCtrl(this, wxID_FONT_SIZE, wxT("12"), wxDefaultPosition, wxSize(80, wxDefaultCoord), wxSP_ARROW_KEYS, 1, 500, 12);
...
#else
    m_pointSizeChoice = NEW_DEBUG wxChoice( this, wxID_FONT_SIZE, wxDefaultPosition, wxDefaultSize, 40, pointSizes, 0 );
    ...
    if (m_fontData.GetEnableEffects())
    {
        wxBoxSizer* itemBoxSizer20 = NEW_DEBUG wxBoxSizer(wxVERTICAL);
        itemGridSizer4->Add(itemBoxSizer20, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
        m_underLineCheckBox = NEW_DEBUG wxCheckBox( this, wxID_FONT_UNDERLINE, _("&Underline"), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    wxStaticText* itemStaticText23 = NEW_DEBUG wxStaticText( this, wxID_STATIC, _("Preview:"), wxDefaultPosition, wxDefaultSize, 0 );
    itemBoxSizer3->Add(itemStaticText23, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT|wxTOP, 5);

    m_previewer = NEW_DEBUG wxFontPreviewer( this );
...
#ifdef __WXMAC__
    wxButton* itemButton28 = NEW_DEBUG wxButton( this, wxID_CANCEL, _("&Cancel"), wxDefaultPosition, wxDefaultSize, 0 );
    if (ShowToolTips())
    ...
    wxButton* itemButton27 = NEW_DEBUG wxButton( this, wxID_OK, _("&OK"), wxDefaultPosition, wxDefaultSize, 0 );
