...
public:
    ...
    virtual wxEvent *Clone() const wxOVERRIDE { return NEW_DEBUG wxQueryLayoutInfoEvent(*this); }
...
public:
    ...
    virtual wxEvent *Clone() const wxOVERRIDE { return NEW_DEBUG wxCalculateLayoutEvent(*this); }
