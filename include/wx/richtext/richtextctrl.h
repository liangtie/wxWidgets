...
public:
  wxRichTextDropTarget(wxRichTextCtrl* tc)
    : wxDropTarget(NEW_DEBUG wxRichTextBufferDataObject(NEW_DEBUG wxRichTextBuffer)), m_rtc(tc) {}
...
public:
    ...
    */
    ...
    virtual wxEvent *Clone() const wxOVERRIDE { return NEW_DEBUG wxRichTextEvent(*this); }
